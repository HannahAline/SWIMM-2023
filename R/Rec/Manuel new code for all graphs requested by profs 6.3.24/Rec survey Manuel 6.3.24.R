...
dat <- read.csv("C:\\Users\\manue\\OneDrive\\Desktop\\new SWIMM\\Recreational Anglers (Pescadores recreativos)_June 3, 2024_10.08.csv", header = TRUE)
...
#### number of surveys fully completed
table(dat$Progress)
...
ggplot(data = yeardat, aes(x = Q32, fill = Country)) +
  ...
  labs(title = "USA n=158, Mex n=120",
       x = "What year were you born?",
       y = "Count") +
  theme_classic()
#ggsave("birthyear.png", width = 10, height = 8, dpi = 1000)
...
ggplot(data = countrydat[!is.na(countrydat$Q44), ], aes(x = Q44)) +
  ...
  labs(x = "What country do you currently reside in?",
       y = "Count") +
  theme_classic()
#ggsave("countryofresidence.png", width = 10, height = 8, dpi = 1000)
...
ggplot(data = gendat[!is.na(gendat$Q35),], aes(x = Q35, fill = Country)) +
  ...
  labs(title = "USA n=139, Mex n=114",
       x = "Please indicate your gender",
       y = "Count") +
  theme_classic()
#ggsave("gender.png", width = 10, height = 8, dpi = 1000)
...
ggplot(q40final, aes(x = Occupation, y = OccupationN, fill = Country)) +
  ...
  labs(x = "What is your current occupation? Select all that apply"
       , y = "Count",title = "USA n=139, Mex n=110") +
  theme_classic()
#ggsave("occupation.png", width = 10, height = 8, dpi = 1000)
...
### it was decided in the most recent meeting that this question was not clear enough,
### thus, can be omitted from analyses
...
ggplot(allq3, aes(x=Country, y=Q3, fill=Country)) + 
  ...
  theme_classic() +
  labs(title = "USA n=129, Mex n=102",
       y = "How many years have you been practicing recreational fishing?") +
  theme(legend.position="none")
#ggsave("yearsrecfishing.png", width = 8, height = 10, dpi = 1000)
...
ggplot(q4final, aes(x = boat, y = boatn, fill = Country)) +
  ...
  labs(x = "Is your boat... Select all that apply"
       , y = "Count",title = "USA n=137, Mex n=100") +
  theme_classic()
#ggsave("boat.png", width = 10, height = 8, dpi = 1000)
...
ggplot(data=finalrecdays, aes(x=Var1, y=Freq, fill = Country)) +
  ...
  labs(x = "On average, how many days a year do you fish for recreational purposes?",
       y = "Count",title = "USA n=134, Mex n=99")
#ggsave("daysrecfishing.png", width = 10, height = 8, dpi = 1000)
...
ggplot(data=finalgomdays, aes(x=Var1, y=Freq, fill = Country)) +
  ...
  theme_classic() +
  labs(x = "How many days do you fish recreationally anywhere in the Gulf of Mexico?",
       y = "Count",title = "USA n=134, Mex n=97")
#ggsave("daysrecfishinggom.png", width = 10, height = 8, dpi = 1000)
...
ggplot(q14final,
  ...
  labs(x = "In what type of habitats do you like to fish? Select all that apply"
       , y = "Count",title = "USA n=158, Mex n=120") +
  theme_classic()
#ggsave("habitats.png", width = 10, height = 8, dpi = 1000)
...
nrow(q15answeredusa) # usa smaple size
...
nrow(q15answeredmex) # mex sample size
...
ggplot(q15final,
  ...
  labs(x = "What kind of fishing technique do you use? Select all that apply",
       y = "Count",title = "USA n=158, Mex n=120") +
  theme_classic()
#ggsave("fishingtechniques.png", width = 10, height = 8, dpi = 1000)
...
ggplot(q16final, aes(x = Var1, y = Freq, fill = Country)) +
  ...
  labs(x = "How many sport fishing tournaments do you attend each year?",
       y = "Count",title = "USA n=134, Mex n=99") +
  theme_classic()
#ggsave("tournaments.png", width = 10, height = 8, dpi = 1000)
...
mextour <- ggplot(data=q51mex, aes(x=Var1, y=Freq)) +
  ...
  labs(x = "In the last year, how much have you paid individually to enter fishing tournaments? (USD converted)",
       y = "Count",title = "Mex n=55") + ylim(0, 20) +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))
...
ggplot(investminusoutlier, aes(x=Country, y=inv, fill=Country)) + 
  ...
  stat_summary(fun.y=mean, geom="point", size=3) +
  theme_classic() +
  labs(title = "USA n=110, Mex n=72; 3 USA outliers (not displayed) = 50,000, 100,000, and 640,000",
...
usaitems <- ggplot(asdf, aes(x=Item, y=Mean)) + 
  ...
  labs(title = "USA n=102", y="On average, how much have you spent in the last year on these items? (USD)")
